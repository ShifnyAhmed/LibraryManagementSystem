...
public class Returned {
    ...
    public Returned(Long id, Long book_id, String email, String book_name, String reserved_date, String allowed_return_date, String actual_return_date, int lending_duration, int lending_charges, int overdue_charges, int total, String status) {
        this.id = id;
    ...
    public Returned(Long book_id, String email, String book_name, String reserved_date, String allowed_return_date, String actual_return_date, int lending_duration, int lending_charges, int overdue_charges, int total, String status) {
        this.book_id = book_id;
        this.email = email;
        this.book_name = book_name;
        this.reserved_date = reserved_date;
